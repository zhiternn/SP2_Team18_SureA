...
void MS::RotateFromPivot(float pivotX, float pivotY, float pivotZ, float degrees, float axisX, float axisY, float axisZ) {
	Mtx44 mat;
	mat.SetToTranslation(pivotX, pivotY, pivotZ);
	ms.top() = ms.top() * mat;
